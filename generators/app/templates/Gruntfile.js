...
module.exports = function(grunt) {
	...
	grunt.registerTask('serve', function() {
		grunt.task.run(['clean:dist', 'eslint', 'uglify', 'jade', 'sass', 'reactTemplates', 'babel', 'replace', 'copy', 'clean-dist',
			'connect', 'open', 'watch'
		]);
	});
	...
	grunt.registerTask('rebuild', function() {
		grunt.task.run(['clean:dist', 'uglify', 'jade', 'sass', 'reactTemplates', 'babel', 'replace', 'copy', 'clean-dist']);
	});
};